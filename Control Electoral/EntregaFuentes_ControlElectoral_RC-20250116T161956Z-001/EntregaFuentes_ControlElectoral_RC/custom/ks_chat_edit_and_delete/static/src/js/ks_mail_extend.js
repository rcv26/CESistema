...
//    var ks_thread = require('mail.widget.Thread');
    var ks_thread = require('ks_chat_edit_and_delete.widget.Thread');
//    var ks_abstract_message = require('mail.model.AbstractMessage');
    var ks_abstract_message = require('ks_chat_edit_and_delete.model.AbstractMessage');
//    var ks_model_message = require('mail.model.Message');
    var ks_model_message = require('ks_chat_edit_and_delete.model.Message');
